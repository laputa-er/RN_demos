        ...
        <Modal
            ...
            }
            {
              ...
              ? <View style={styles.loadingBox}>
                  ...
                  { this.state.willPublish && <Text style={styles.loadingText}>正在合并视频音频...</Text> }
                  { this.state.publishProgress > 0.3 && <Text style={styles.loadingText}>开始上传喽！...</Text> }
                  <Progress.Circle
                    showsText={true}
                    size={60}
                    color="#ee735c"
